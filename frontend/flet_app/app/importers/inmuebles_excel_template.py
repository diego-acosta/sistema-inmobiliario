...
COLUMN_HELP: Final[tuple[tuple[str, str, str, str, str], ...]] = (
    ...
    ("fecha_desde", "Opcional", "Fecha AAAA-MM-DD", "Inicio de vigencia del dato catastral/registral; puede quedar vacía en una carga normal y no se completa automáticamente.", "fecha_desde, vigencia_desde"),
    ("fecha_hasta", "Opcional", "Fecha AAAA-MM-DD", "Fin de vigencia del dato catastral/registral; puede quedar vacía en una carga normal y no puede ser anterior a fecha_desde.", "fecha_hasta, vigencia_hasta"),
...
VALIDATION_RULES: Final[tuple[str, ...]] = (
    ...
    "fecha_desde y fecha_hasta son opcionales, indican vigencia del dato catastral/registral y pueden quedar vacías en una carga normal.",
