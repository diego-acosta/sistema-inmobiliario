        ...
        return ft.Container(
            content=ft.Column(
                [
                    ...
                    ft.Text("fecha_desde y fecha_hasta son opcionales e informativas para el dato catastral/registral principal; no implementan historial formal ni cierre automático."),
