...
class VentaCreateWizardPage:
    ...
    def _step_objetos(self) -> ft.Control:
        return self._card(
            ...
            [
                ft.Text("Versión inicial: selector demo. En productivo debe validar disponibilidad, modalidad y coherencia multiobjeto."),
                _simple_table(["Tipo", "ID", "Descripción", "Precio"], [_objeto_row(obj) for obj in self.state.objetos]),
                ft.Row(
                    controls=[
    ...
    def _step_compradores(self) -> ft.Control:
        return self._card(
            ...
            [
                ft.Text("Regla inicial: exactamente un comprador financiero resoluble para Plan Pago V2."),
    ...
    def _step_plan_pago(self) -> ft.Control:
        ...
        return self._card(
            ...
            [
                ft.Text("Carga la estructura del plan. El cronograma se revisa en la pestaña siguiente antes de confirmar.", color=ft.Colors.BLUE_GREY_700),
                tipo_pago_dropdown,
                _simple_table(
    ...
    def _step_revision(self) -> ft.Control:
        ...
        return self._card(
            ...
            [
                ft.Text("Revisá toda la venta y el cronograma antes de confirmar. La confirmación está simulada hasta tener orquestación backend."),
                _kv_grid([
