...
| Frontend financiero | NUCLEO_DOMINIO | IMPLEMENTADO_PARCIALMENTE | Estado de cuenta y simulación en Parte; vistas PPV2 financieras. | Completar pagos, imputaciones, reversión, conciliación financiera, mora e índices; la gestión de Caja física permanece en el frontend Operativo. | COORDINADOR: #208; OWNER_VIGENTE de indexación UI: #348; OWNER_ISSUE = FALTA para pagos UI | Backend/seguridad; integración Pago ↔ movimiento físico cuando corresponda | Sí | CRÍTICA |
...
| Frontend Financiero | NUCLEO_DOMINIO | IMPLEMENTADO_PARCIALMENTE | Existen estado de cuenta y simulación. | Completar pagos reales y demás operaciones financieras. | COORDINADOR: #208 | Backend/seguridad | Sí | CRÍTICA |
