...
| Garantías monetarias | NUCLEO_DOMINIO | DOCUMENTADO_NO_IMPLEMENTADO | SRV-FIN-011 documenta la capacidad, pero no prueba tabla funcional ni circuito application/API/tests de constitución, afectación, liberación o ejecución. | Diseñar e implementar el circuito financiero; no confundirlo con garantías contractuales locativas ni con Pago ↔ Caja física. | OWNER_ISSUE = FALTA focal | Tesorería; contratos generadores cuando corresponda | Sí para esa cobertura financiera | ALTA |
