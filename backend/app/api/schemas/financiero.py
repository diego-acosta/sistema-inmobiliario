...
class EgresoProveedorFacturaServicioRequest(BaseModel):
...
class EgresoProveedorFacturaServicioData(BaseModel):
    resultado: str | None = None
...
class EgresoProveedorFacturaServicioResponse(BaseModel):
    ok: bool = True
