...
class AnularEgresoImpuestoEmpresaService:
    ...
    def _execute_in_transaction(
        ...
        egreso = self.repository.get_egreso_impuesto_empresa_by_id(id_egreso)
        if egreso is None:
            return AppResult.fail("EGRESO_IMPUESTO_NOT_FOUND")
...
def _response(values: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "id_egreso_impuesto_empresa": values["id_egreso_impuesto_empresa"],
