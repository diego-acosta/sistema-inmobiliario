...
def test_update_disponibilidad_devuelve_validation_error_si_falta_if_match_version(client) -> None:
    response = client.put(
        "/api/v1/disponibilidades/999999",
        headers=HEADERS,
        json={
...
def test_update_disponibilidad_devuelve_validation_error_si_if_match_version_invalido(client) -> None:
    response = client.put(
        "/api/v1/disponibilidades/999999",
