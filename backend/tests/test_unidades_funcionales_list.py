...
def test_get_unidades_funcionales_global_devuelve_solo_no_borradas(
    client, db_session
) -> None:
    inmueble_response = client.post(
        ...
        json={
            "id_desarrollo": None,
            "codigo_inmueble": "INM-UF-GLOB-001",
            "nombre_inmueble": "Inmueble Global UF",
            "superficie": "190.00",
    ...
    response_1 = client.post(
        ...
        json={
            ...
            "nombre_unidad": "Unidad Global Uno",
            "superficie": "91.11",
    ...
    response_2 = client.post(
        ...
        headers=HEADERS,
        json={
            "codigo_unidad": "UF-GLOB-002",
            "nombre_unidad": "Unidad Global Dos",
            "superficie": "99.99",
    ...
    response = client.get("/api/v1/unidades-funcionales")
    ...
    assert row["codigo_unidad"] == "UF-GLOB-001"
    assert row["nombre_unidad"] == "Unidad Global Uno"
    assert str(row["superficie"]) == "91.11"
...
def test_get_unidades_funcionales_global_devuelve_lista_vacia_si_no_hay_registros_activos(
    client, db_session
) -> None:
    db_session.execute(text("UPDATE unidad_funcional SET deleted_at = CURRENT_TIMESTAMP"))
