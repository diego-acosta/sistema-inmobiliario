...
def test_update_persona_contacto_actualiza_en_postgresql(client, db_session) -> None:
    persona_response = client.post(
        ...
        json={
            ...
            "observaciones": "persona creada para test update contacto",
        },
    )
    ...
    contacto_data = contacto_response.json()["data"]
    id_persona_contacto = contacto_data["id_persona_contacto"]
    ...
    response = client.put(
        ...
        json={
            "tipo_contacto": "EMAIL",
            "valor_contacto": "nuevo@mail.com",
            "es_principal": True,
            "fecha_desde": "2024-02-01",
            "fecha_hasta": None,
            "observaciones": "contacto actualizado",
        },
    )
    ...
    assert row["valor_contacto"] == "nuevo@mail.com"
    assert row["es_principal"] is True
    assert row["observaciones"] == "contacto actualizado"
...
def test_update_persona_contacto_devuelve_409_si_falta_if_match_version(client) -> None:
    persona_response = client.post(
        ...
        json={
            ...
            "estado_persona": "ACTIVA",
            "observaciones": "persona para conflicto",
        },
    )
    id_persona = persona_response.json()["data"]["id_persona"]
...
def test_update_persona_contacto_devuelve_409_si_if_match_version_es_invalido(
    ...
    persona_response = client.post(
        ...
        json={
            ...
            "estado_persona": "ACTIVA",
            "observaciones": "persona para if-match invalido",
        },
    )
    id_persona = persona_response.json()["data"]["id_persona"]
...
def test_update_persona_contacto_devuelve_404_si_contacto_esta_soft_deleted(
    client, db_session
) -> None:
    persona_response = client.post(
        "/api/v1/personas",
...
def test_update_persona_contacto_devuelve_409_si_update_no_afecta_filas_por_version(
...
def test_update_persona_contacto_devuelve_404_si_contacto_no_pertenece_a_persona(
    client,
) -> None:
    ...
    response = client.put(
        f"/api/v1/personas/{persona_2}/contactos/{contacto}",
        headers={**HEADERS, "If-Match-Version": "1"},
        json={
            "tipo_contacto": "EMAIL",
            "valor_contacto": "otro@mail.com",
            "es_principal": True,
            "fecha_desde": None,
            "fecha_hasta": None,
            "observaciones": None,
