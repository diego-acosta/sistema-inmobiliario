...
| impuesto trasladado | `COMPROBANTE_IMPUESTO` como origen documental; `LIQUIDACION_IMPUESTO_TRASLADADO` o materializacion directa pendiente | `IMPUESTO_TRASLADADO` | Impuesto, tasa o contribucion trasladada. No usa `factura_servicio`, no crea `IMPUESTO_RECUPERADO` en V1. El egreso empresa se registra aparte con `egreso_impuesto_empresa` y no crea obligacion. |
...
- `EXPENSA_TRASLADADA`
- `SERVICIO_TRASLADADO`
- `SERVICIO_RECUPERADO` (recupero V1 de servicios comunes pagados por la empresa; se materializa desde `liquidacion_recupero`)
- `IMPUESTO_TRASLADADO`
- `INTERES_FINANCIERO`
- `PUNITORIO`
