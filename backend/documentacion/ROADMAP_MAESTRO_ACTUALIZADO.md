...
| Locativo | parcial/amplio | Medio/alto: router, schemas, services, repository y tests propios materializados para contratos, condiciones economicas, solicitudes, reservas locativas, generacion de contrato desde reserva, entrega, restitucion y objetos locativos/multiobjeto | Medio/alto: `DEV-API`, `DER`, `DEV-ARCH`, `DEV-SRV`, `CAT-CU`; requiere mantener sincronizado con backend real | Mantener y cerrar drifts documentales; nuevos subflujos entran como backlog especifico |
