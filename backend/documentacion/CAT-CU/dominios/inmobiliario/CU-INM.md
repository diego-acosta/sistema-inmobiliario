...
| CU-INM-047 | Registro de factura de servicio externo | IMPLEMENTADO V1 | Actor: operador. Entrada: datos de factura del proveedor externo. Salida: registro interno consultable por API. No emite evento, no tiene consumer financiero y no genera obligacion financiera |
