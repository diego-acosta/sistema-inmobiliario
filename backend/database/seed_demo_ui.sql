...
BEGIN
    ...
    INSERT INTO public.inmueble_servicio (
        id_instalacion_origen, id_instalacion_ultima_modificacion,
        op_id_alta, op_id_ultima_modificacion,
        id_inmueble, id_servicio, estado, fecha_alta
    )
    SELECT 1, 1, v_op_id, v_op_id, x.id_inmueble, x.id_servicio, 'ACTIVO', TIMESTAMP '2026-01-01 00:00:00'
    FROM (VALUES
    ...
    INSERT INTO public.unidad_funcional_servicio (
        id_instalacion_origen, id_instalacion_ultima_modificacion,
        op_id_alta, op_id_ultima_modificacion,
        id_unidad_funcional, id_servicio, estado, fecha_alta
    )
    SELECT 1, 1, v_op_id, v_op_id, x.id_unidad_funcional, x.id_servicio, 'ACTIVO', TIMESTAMP '2026-01-01 00:00:00'
    FROM (VALUES
    ...
    SELECT 1, 1, v_op_id, v_op_id, ofi.id_obligacion_financiera,
           x.id_persona, x.rol_obligado, 100.00
    FROM (VALUES
