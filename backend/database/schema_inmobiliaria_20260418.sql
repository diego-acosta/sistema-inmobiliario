...
--
-- Patch inline: liquidacion_recupero V1
--
...
CREATE TABLE IF NOT EXISTS public.liquidacion_recupero (
    ...
    CONSTRAINT fk_lr_relacion_generadora FOREIGN KEY (id_relacion_generadora) REFERENCES public.relacion_generadora(id_relacion_generadora) ON DELETE RESTRICT,
    CONSTRAINT fk_lr_obligacion_financiera FOREIGN KEY (id_obligacion_financiera) REFERENCES public.obligacion_financiera(id_obligacion_financiera) ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS public.liquidacion_recupero_factura (
    ...
    CONSTRAINT fk_lrf_liquidacion FOREIGN KEY (id_liquidacion_recupero) REFERENCES public.liquidacion_recupero(id_liquidacion_recupero) ON DELETE RESTRICT,
    CONSTRAINT fk_lrf_factura_servicio FOREIGN KEY (id_factura_servicio) REFERENCES public.factura_servicio(id_factura_servicio) ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS public.liquidacion_recupero_egreso (
    ...
    CONSTRAINT fk_lre_liquidacion FOREIGN KEY (id_liquidacion_recupero) REFERENCES public.liquidacion_recupero(id_liquidacion_recupero) ON DELETE RESTRICT,
    CONSTRAINT fk_lre_egreso FOREIGN KEY (id_egreso_proveedor_factura_servicio) REFERENCES public.egreso_proveedor_factura_servicio(id_egreso_proveedor_factura_servicio) ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS public.liquidacion_recupero_responsable (
    ...
    CONSTRAINT fk_lrr_liquidacion FOREIGN KEY (id_liquidacion_recupero) REFERENCES public.liquidacion_recupero(id_liquidacion_recupero) ON DELETE RESTRICT,
    CONSTRAINT fk_lrr_persona FOREIGN KEY (id_persona) REFERENCES public.persona(id_persona) ON DELETE RESTRICT,
    CONSTRAINT fk_lrr_asignacion FOREIGN KEY (id_asignacion_servicio_responsable) REFERENCES public.asignacion_servicio_responsable(id_asignacion_servicio_responsable) ON DELETE RESTRICT
);

CREATE UNIQUE INDEX IF NOT EXISTS ux_lr_op_id_alta_activo ON public.liquidacion_recupero (op_id_alta) WHERE op_id_alta IS NOT NULL AND deleted_at IS NULL;
CREATE UNIQUE INDEX IF NOT EXISTS ux_lr_codigo_activo ON public.liquidacion_recupero (codigo_liquidacion_recupero) WHERE codigo_liquidacion_recupero IS NOT NULL AND deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_lr_relacion_generadora ON public.liquidacion_recupero (id_relacion_generadora);
CREATE INDEX IF NOT EXISTS idx_lr_obligacion_financiera ON public.liquidacion_recupero (id_obligacion_financiera);
CREATE INDEX IF NOT EXISTS idx_lrf_factura_servicio ON public.liquidacion_recupero_factura (id_factura_servicio);
CREATE UNIQUE INDEX IF NOT EXISTS ux_lre_egreso_activo ON public.liquidacion_recupero_egreso (id_egreso_proveedor_factura_servicio);
CREATE INDEX IF NOT EXISTS idx_lrr_persona ON public.liquidacion_recupero_responsable (id_persona);
