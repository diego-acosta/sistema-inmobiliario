...
VALUES
    ('CAPITAL_VENTA', 'Capital de venta', 'Componente de capital asociado a una venta.', 'CAPITAL', 'DEBITO', true, false, false, true, false, true, true, true, 'ACTIVO', 'Catalogo financiero base'),
    ('ANTICIPO_VENTA', 'Anticipo de venta', 'Anticipo financiero asociado a una venta.', 'CAPITAL', 'DEBITO', true, false, false, false, false, true, true, true, 'ACTIVO', 'Catalogo financiero base'),
    ('SALDO_EXTRAORDINARIO', 'Saldo extraordinario', 'Saldo extraordinario generado fuera del cronograma ordinario.', 'CAPITAL', 'DEBITO', true, false, false, true, false, true, true, true, 'ACTIVO', 'Catalogo financiero base'),
    ...
    ('PUNITORIO', 'Punitorio', 'Cargo punitorio por incumplimiento.', 'MORA', 'DEBITO', false, false, true, false, false, true, true, true, 'ACTIVO', 'Catalogo financiero base'),
    ('CARGO_ADMINISTRATIVO', 'Cargo administrativo', 'Cargo administrativo financiero.', 'CARGO', 'DEBITO', false, false, false, false, false, true, true, true, 'ACTIVO', 'Catalogo financiero base'),
    ('LIQUIDACION_FINAL', 'Liquidacion final', 'Componente de liquidacion final.', 'CIERRE', 'DEBITO', false, false, false, false, false, true, true, true, 'ACTIVO', 'Catalogo financiero base'),
    ('REFINANCIACION', 'Refinanciacion', 'Componente asociado a refinanciacion.', 'REFINANCIACION', 'DEBITO', false, false, false, false, false, true, true, true, 'ACTIVO', 'Catalogo financiero base'),
    ('CANCELACION_ANTICIPADA', 'Cancelacion anticipada', 'Componente asociado a cancelacion anticipada.', 'CIERRE', 'DEBITO', false, false, false, false, false, true, true, true, 'ACTIVO', 'Catalogo financiero base'),
    ('AJUSTE_INDEXACION', 'Ajuste por indexacion', 'Ajuste financiero por indice o actualizacion.', 'AJUSTE', 'DEBITO', false, false, false, false, false, true, true, true, 'ACTIVO', 'Catalogo financiero base'),
    ('CREDITO_MANUAL', 'Credito manual', 'Credito manual documentado.', 'AJUSTE', 'CREDITO', false, false, false, false, false, false, true, true, 'ACTIVO', 'Catalogo financiero base'),
    ('DEBITO_MANUAL', 'Debito manual', 'Debito manual documentado.', 'AJUSTE', 'DEBITO', false, false, false, false, false, true, true, true, 'ACTIVO', 'Catalogo financiero base')
